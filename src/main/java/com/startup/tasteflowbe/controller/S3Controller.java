...
public class S3Controller {
    ...
    public String testBucketConnection() {
        s3Service.testConnectionToBucket("tasteflow"); // Thay "tasteflow" bằng tên bucket của bạn
    ...
    public String listBucketObjects() {
        s3Service.listObjectsInBucket("tasteflow"); // Thay "tasteflow" bằng tên bucket của bạn
    ...
    private String generateUniqueKey(String filePath) {
        String fileName = Paths.get(filePath).getFileName().toString();  // Lấy tên file gốc
    ...
    public String downloadFile() {
        ...
        String downloadPath = "path/to/local/downloaded-file.txt"; // Đường dẫn lưu file đã tải về
